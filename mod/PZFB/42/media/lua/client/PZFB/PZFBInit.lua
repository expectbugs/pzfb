...
local function generateInstallScript()
    ...
    if isWindows() then
        ...
        writer:writeln("    \"C:\\Program Files (x86)\\Steam\\steamapps\\common\\ProjectZomboid\\projectzomboid\"")
        writer:writeln("    \"C:\\Program Files\\Steam\\steamapps\\common\\ProjectZomboid\\projectzomboid\"")
        writer:writeln("    \"D:\\Steam\\steamapps\\common\\ProjectZomboid\\projectzomboid\"")
        writer:writeln("    \"D:\\SteamLibrary\\steamapps\\common\\ProjectZomboid\\projectzomboid\"")
        writer:writeln("    \"E:\\Steam\\steamapps\\common\\ProjectZomboid\\projectzomboid\"")
        writer:writeln("    \"E:\\SteamLibrary\\steamapps\\common\\ProjectZomboid\\projectzomboid\"")
        writer:writeln(") do (")
        ...
        writer:writeln("    if exist \"%STEAM_PATH%\\steamapps\\common\\ProjectZomboid\\projectzomboid\\projectzomboid.jar\" (")
        writer:writeln("        set \"PZ_DIR=%STEAM_PATH%\\steamapps\\common\\ProjectZomboid\\projectzomboid\"")
        writer:writeln("        goto :found")
        writer:writeln("    )")
        writer:writeln(")")
